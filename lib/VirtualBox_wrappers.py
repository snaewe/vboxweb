...
class IVirtualBox(IUnknown):
   ...
   def openMedium(self, _arg_location, _arg_deviceType, _arg_accessMode):
...
class IVFSExplorer(IUnknown):
   ...
   def entryList(self):
       ...
       return String(self.mgr,val._aNames, True), UnsignedInt(self.mgr,val._aTypes, True)
...
class IMachine(IUnknown):
   ...
   def readSavedThumbnailToArray(self, _arg_screenId, _arg_BGR):
       ...
       return Octet(self.mgr,val._returnval, True), UnsignedInt(self.mgr,val._width), UnsignedInt(self.mgr,val._height)
   ...
   def readLog(self, _arg_idx, _arg_offset, _arg_size):
       ...
       return Octet(self.mgr,val._returnval, True)
...
class ISystemProperties(IUnknown):
   ...
   def getMaxInstancesOfStorageBus(self, _arg_bus):
   ...
   def getNetworkAdapterCount(self):
       ...
       req._this=self.handle
       val=self.mgr.getPort().ISystemProperties_getNetworkAdapterCount(req)
       return  UnsignedInt(self.mgr,val._returnval)
...
class IGuest(IUnknown):
   ...
   def getAdditionsVersion(self):
       ...
       return  String(self.mgr,val._returnval)
   def getSupportsSeamless(self):
       req=IGuest_getSupportsSeamlessRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().IGuest_getSupportsSeamless(req)
       return  Boolean(self.mgr,val._returnval)
   def getSupportsGraphics(self):
       req=IGuest_getSupportsGraphicsRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().IGuest_getSupportsGraphics(req)
       return  Boolean(self.mgr,val._returnval)
   def getMemoryBalloonSize(self):
   ...
   _Attrs_={         'OSTypeId':[getOSTypeId,None],
         ...
         'supportsSeamless':[getSupportsSeamless,None],
         'supportsGraphics':[getSupportsGraphics,None],
         'memoryBalloonSize':[getMemoryBalloonSize,setMemoryBalloonSize,
        ],
...
class IMedium(IUnknown):
   ...
   def getVariant(self):
       ...
       return  MediumVariant(self.mgr,val._returnval)
...
class IMediumFormat(IUnknown):
   ...
   def getFileExtensions(self):
       req=IMediumFormat_getFileExtensionsRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().IMediumFormat_getFileExtensions(req)
       return  String(self.mgr,val._returnval, True)
...
class INetworkAdapter(IUnknown):
   ...
   def attachToNAT(self):
       ...
       val=self.mgr.getPort().INetworkAdapter_attachToNAT(req)
   ...
   def attachToBridgedInterface(self):
       ...
       val=self.mgr.getPort().INetworkAdapter_attachToBridgedInterface(req)
   ...
   def attachToInternalNetwork(self):
       ...
       val=self.mgr.getPort().INetworkAdapter_attachToInternalNetwork(req)
   ...
   def attachToHostOnlyInterface(self):
       ...
       val=self.mgr.getPort().INetworkAdapter_attachToHostOnlyInterface(req)
       
       return 


   def attachToVDE(self):
       req=INetworkAdapter_attachToVDERequestMsg()
       req._this=self.handle
       
       val=self.mgr.getPort().INetworkAdapter_attachToVDE(req)
   ...
   def detach(self):
       ...
       val=self.mgr.getPort().INetworkAdapter_detach(req)
   ...
   def getHostInterface(self):
       ...
       req._this=self.handle
       val=self.mgr.getPort().INetworkAdapter_getHostInterface(req)
       return  String(self.mgr,val._returnval)
   def setHostInterface(self, value):
       ...
       self.mgr.getPort().INetworkAdapter_setHostInterface(req)
   ...
   def getVDENetwork(self):
       req=INetworkAdapter_getVDENetworkRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().INetworkAdapter_getVDENetwork(req)
       return  String(self.mgr,val._returnval)
   def setVDENetwork(self, value):
       req=INetworkAdapter_setVDENetworkRequestMsg()
       req._this=self.handle
       if type(value) in [int, bool, basestring, str]:
            req._VDENetwork = value
       else:
            req._VDENetwork = value.handle
       self.mgr.getPort().INetworkAdapter_setVDENetwork(req)
   ...
   def getBandwidthLimit(self):
       req=INetworkAdapter_getBandwidthLimitRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().INetworkAdapter_getBandwidthLimit(req)
       return  UnsignedInt(self.mgr,val._returnval)
   def setBandwidthLimit(self, value):
       req=INetworkAdapter_setBandwidthLimitRequestMsg()
       req._this=self.handle
       if type(value) in [int, bool, basestring, str]:
            req._bandwidthLimit = value
       else:
            req._bandwidthLimit = value.handle
       self.mgr.getPort().INetworkAdapter_setBandwidthLimit(req)
   ...
   _Attrs_={         'adapterType':[getAdapterType,setAdapterType,
         ...
         'VDENetwork':[getVDENetwork,setVDENetwork,
        ],
         ...
         'bandwidthLimit':[getBandwidthLimit,setBandwidthLimit,
        ]}
...
class IVRDEServer(IUnknown):
   ...
   _Attrs_={         'enabled':[getEnabled,setEnabled,
         ...
         'videoChannel':[getVideoChannel,setVideoChannel,
        ],
         'videoChannelQuality':[getVideoChannelQuality,setVideoChannelQuality,
        ]}
...
class IMediumAttachment:
    def __init__(self, mgr, handle, isarray = False):
       ...
       if isarray:
          ...
          self.bandwidthLimit = UnsignedInt(self.mgr, handle._bandwidthLimit)
...
class SettingsVersion:
   ...
   _NameMap={0:'Null',1:'v1_0',2:'v1_1',3:'v1_2',4:'v1_3pre',5:'v1_3',6:'v1_4',7:'v1_5',8:'v1_6',9:'v1_7',10:'v1_8',11:'v1_9',12:'v1_10',13:'v1_11',99999:'Future'}
   _ValueMap={
              'Null':0,
              'v1_0':1,
              'v1_1':2,
...
class NetworkAttachmentType:
   ...
   _NameMap={0:'Null',1:'NAT',2:'Bridged',3:'Internal',4:'HostOnly',5:'VDE'}
   _ValueMap={
              'Null':0,
              'NAT':1,
              'Bridged':2,
